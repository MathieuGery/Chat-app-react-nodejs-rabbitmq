...
Feature: Register
  ...
  Scenario: I click on sign-up button
    ...
    And My username have an @ in the 'Username' field
  ...
  Scenario: I click on Register button
    Given I filled 'Username', 'Email', 'Password', 'Confirmation password'
    Then I will be prompted with a message stating 'A mail has been sent to you, please click on the confirmation link to fianlise your registration'
